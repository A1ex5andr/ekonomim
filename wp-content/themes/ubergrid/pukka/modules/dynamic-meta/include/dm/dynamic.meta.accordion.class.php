								...
								$out .= '<li class="dm-meta-accordion-box">
									...
									<div class="dm-content-box">    
										...
										<div class="dm-input-tools">
											...
											<input type="hidden" class="dm-data-input dm-acc-bg-color" value="' . esc_attr($elem->bg_color) . '" data-var="bg_color" />
		...
		public function getOutputHTML($data) {
			...
			for($i = 0; $i < count($content->data); $i++){
				...
				if('on' != pukka_get_option('dm_enable_html')){
					...
					$text_title =  esc_html($elem->text_title);
				}else{
