...
function pukka_media(){
	global $post;
	 ...
	 if( get_post_meta($post->ID, '_pukka_media_url', true) != '' || get_post_meta($post->ID, PUKKA_POSTMETA_PREFIX .'media_embed', true) != ''){
		if( get_post_meta($post->ID, '_pukka_media_url', true) != '' ){
